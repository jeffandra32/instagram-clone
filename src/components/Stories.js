      ...
      <View style={styles.container}>
        ...
        <ScrollView horizontal={true}>
          <View style={styles.myStoryImageWrapper}>
            ...
            />
            <Text style={styles.profileName}>Jefferson</Text>
          </View>
          <View style={styles.otherStoryImageWrapper}>
            ...
            <Image
              ...
              source={require('../assets/images/face.png')}
            />
            <Text style={styles.profileName}>Gohan</Text>
          </View>
          <View style={styles.otherStoryImageWrapper}>
            <Image
              style={styles.storyRound}
            ...
            <Image
              ...
              source={require('../assets/images/face.png')}
            />
            <Text style={styles.profileName}>Goku</Text>
          </View>
          <View style={styles.otherStoryImageWrapper}>
            <Image
              style={styles.storyRound}
            ...
            <Image
              ...
              source={require('../assets/images/face.png')}
            />
            <Text style={styles.profileName}>Vegeta</Text>
          </View>
        </ScrollView>
      </View>
    );
